...
data = [forces{4} forces{5} forces{6} cop{4} cop{5} cop{6} ...
    forces{1} forces{2} forces{3} cop{1} cop{2} cop{3} ...
    torques{4} torques{5} torques{6} torques{1} torques{2} torques{3}];
